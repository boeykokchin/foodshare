        ...
        <li class="list-group-item card-body">
            <table class="table-padding">
                ...
                <tr>
                    ...
                    <td><a href="{{ url('/user/'.$user->id.'/posts')}}">Show
                            All</a></td>
                    @endif
                </tr>
                <tr>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <p>
            <strong><a
                    href="{{ url('/'.$latest_post->slug) }}">{{ $latest_post->title }}</a></strong>
            <span class="well-sm">On
                {{ $latest_post->created_at->format('M d,Y \a\t h:i a') }}</span>
        </p>
        @endforeach
        @else
...
<div class="card">
    ...
    <div class="list-group">
        ...
        @else
        <div class="list-group-item">
            <p>You have not commented till now. Your latest 5 comments will be
                displayed here</p>
        </div>
        @endif
    </div>
